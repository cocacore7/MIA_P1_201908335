...
COMFDISK:   sizee igual digito COMFDISK             {int tam=atoi($3); ffdisco->size=tam; $$=ffdisco;};
            ...
            |addd igual digito COMFDISK             {int tam=atoi($3); ffdisco->addd=tam; $$=ffdisco;};
            |addd igual negativo digito COMFDISK    {int tam=atoi($4); ffdisco->addd=tam * -1; $$=ffdisco;};
            |sizee igual digito                     {int tam=atoi($3); ffdisco->size=tam; $$=ffdisco;};
            ...
            |addd igual digito                      {int tam=atoi($3); ffdisco->addd=tam; $$=ffdisco;};
            |addd igual negativo digito             {int tam=atoi($4); ffdisco->addd=tam*-1; $$=ffdisco;};
